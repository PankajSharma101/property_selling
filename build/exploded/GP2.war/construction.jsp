            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="propertyList.jsp" class="nav-item nav-link">Property</a>
                        <a href="construction.jsp" class="nav-item nav-link active">Construction</a>
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h2 class="display-5 animated fadeIn mb-4"><span class="text-primary">BUILDING DREAMS,</span><br>CRAFTING PERFECTION.</h2>
                    <h4 class="animated fadeIn mb-4 pb-2">All types of Construction Available. <BR><I>Contact Now!</I></h4>

                    <!-- <h5 class="animated fadeIn mb-4 pb-2">Contact Now!</h5>  -->
         ...
         <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>Get in Touch with Us and Let Us Help You Navigate the Real Estate Market - Your Dream Property is Just a Call or Email Away </p>
                </div>
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                                <div class="bg-light rounded p-3">
                                    <div class="d-flex align-items-center bg-white rounded p-3" style="border: 1px dashed rgba(0, 185, 142, .3)">
                                        ...
                                        <span>brk.aiimers@gmail.com</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="bg-light rounded p-3">
                                    <div class="d-flex align-items-center bg-white rounded p-3" style="border: 1px dashed rgba(0, 185, 142, .3)">
                                        ...
                                        <span>+91 9914814433<BR>+91 9417470077</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <img src="img/call-to-action.jpg" alt="" height="390px" width="560px">
                    </div>
                   ...
                   <!--  <div>
                        <img src="img/carousel-1.jpg" alt="" height="50px" width="50px">
                    </div> -->
                    <div class="col-md-6">
                        
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <!-- <p class="mb-4">Get in Touch with Us and Let Us Help You Navigate the Real Estate Market - Your Dream Property is Just a Call or Email Away </p> -->
                             <form action="saveLead.jsp" method="post">
                                <div class="row g-3">
                                    <div class="col-md-6">
